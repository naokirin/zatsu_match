...
describe('Slack Command Handler', () => {
  ...
  describe('handleSlackCommand', () => {
    it('should handle /zatsu_match command', async () => {
      ...
      // 1時間間隔のmockを返す
      mockParseTimeRange.mockReturnValue(['2024-01-02T10:00', '2024-01-02T10:30']);

      await handleSlackCommand(mockCommand, { traceId: 'test-trace-id' });

      expect(mockParseTimeRange).toHaveBeenCalledWith('2024-01-02', '10:00-11:00');
      expect(mockRegisterAvailability).toHaveBeenCalledTimes(2);
      expect(mockRegisterAvailability).toHaveBeenCalledWith('test-user', '2024-01-02T10:00', 'test-channel');
      expect(mockRegisterAvailability).toHaveBeenCalledWith('test-user', '2024-01-02T10:30', 'test-channel');
    });
    ...
    it('should handle 30 minute interval registration', async () => {
      ...
      // 30分間隔のmockを返す
      mockParseTimeRange.mockReturnValue(['2024-01-02T10:30', '2024-01-02T11:00', '2024-01-02T11:30']);

      await handleSlackCommand(mockCommand, { traceId: 'test-trace-id' });

      expect(mockParseTimeRange).toHaveBeenCalledWith('2024-01-02', '10:30-12:00');
      expect(mockRegisterAvailability).toHaveBeenCalledTimes(3);
      expect(mockRegisterAvailability).toHaveBeenCalledWith('test-user', '2024-01-02T10:30', 'test-channel');
      expect(mockRegisterAvailability).toHaveBeenCalledWith('test-user', '2024-01-02T11:00', 'test-channel');
      expect(mockRegisterAvailability).toHaveBeenCalledWith('test-user', '2024-01-02T11:30', 'test-channel');
    });
  ...
  describe('handle delete command', () => {
    it('should handle delete with time range', async () => {
      ...
      // 30分間隔のmockを返す
      mockParseTimeRange.mockReturnValue(['2024-01-02T10:30', '2024-01-02T11:00']);

      await handleSlackCommand(mockCommand, { traceId: 'test-trace-id' });

      expect(mockParseTimeRange).toHaveBeenCalledWith('2024-01-02', '10:30-11:30');
      expect(mockDeleteAvailability).toHaveBeenCalledTimes(2);
      expect(mockDeleteAvailability).toHaveBeenCalledWith('test-user', '2024-01-02T10:30');
      expect(mockDeleteAvailability).toHaveBeenCalledWith('test-user', '2024-01-02T11:00');
    });
  ...
  describe('handle list command', () => {
    it('should format availabilities with both hour and half-hour intervals', async () => {
      ...
      mockGetUserAvailabilities.mockResolvedValue([
        { userId: 'test-user', timestamp: '2024-01-02T10:00', channelId: 'test-channel' },
        { userId: 'test-user', timestamp: '2024-01-02T10:30', channelId: 'test-channel' },
        { userId: 'test-user', timestamp: '2024-01-02T13:00', channelId: 'test-channel' },
        { userId: 'test-user', timestamp: '2024-01-03T14:30', channelId: 'test-channel' }
      ]);
      ...
      expect(sendSlackEphemeralMessage).toHaveBeenCalledWith(
        'test-channel',
        'test-user',
        expect.stringContaining('2024-01-02: 10:00-10:30, 10:30-11:00, 13:00-13:30')
      );
